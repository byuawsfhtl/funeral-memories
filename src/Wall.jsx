  ...
  return (
    <div>
      <div className="pt-3 pb-3 text-center">
        <h2 className="text-center"  style={{ fontFamily: 'Merriweather, serif',fontWeight:600 }}>Memory Wall for Group {groupId}</h2>
      </div>
      ...
      {showDetail && selectedMemory && (
        <div className="popup-overlay" onClick={() => setShowDetail(false)}>
          <div className="popup text-start" onClick={(e) => e.stopPropagation()}>
