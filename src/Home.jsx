...
export default function Home(){
    ...
    <main className="container my-4 flex-grow-1 d-flex flex-column">
      ...
      <button className="btn btn-primary mt"> <a href="instructions.html" className="text-white text-decoration-none">Click here if you're new! (instructions)</a></button>
      <br/><br/>
      <form method="get" action="./wall.html">
        <div className="mb-3">
      ...
      <button type="submit" className="btn btn-secondary"><a href="./instructions.html" className="text-white text-decoration-none">Host</a></button>
    </main>
    );
}