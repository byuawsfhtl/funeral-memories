...
export default function Home() {
    ...
    useEffect(() => {
        ...
        let heroObserver;
        if (hero) {
            heroObserver = new window.IntersectionObserver((entries, observer) => {
        ...
        <main className="home-page">
            <div className="hero" ref={heroRef}>
                <div className="hero-left">
                    <p className="hero-eyebrow">A private digital memorial space</p>
                    <h1 className="tagline">Share and honor the memories of your loved ones</h1>
                    <p className="hero-description">
                        Create a secure memory page where family and friends can gather,
                        contribute, and keep stories alive for future generations.
                    </p>
                    <div className="hero-actions">
                        <button className="new-button" onClick={() => navigate("/instructions")}>New? Start Here</button>
                    </div>
                </div>
                <div className="hero-right">
                    <div className="cta-panel">
                        <p className="cta-panel-title">Continue</p>
                        ...
                        <button className="mobile-instructions-link" onClick={() => navigate("/instructions")}>
                            New here? View instructions
                        </button>
                        <p className="cta-panel-note">No downloads required. Works in any modern browser.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="cards-section">
                <p className="section-kicker">Simple in three steps</p>
                ...
                <div className="cards-container">
                    ...
                    <div className="card">
                        ...
                        <p>Set up a dedicated page for your loved one with a title, details, and access settings.</p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Invite close family and friends so everyone can contribute meaningful stories together.</p>
                    </div>
                    ...
                    <div className="card">
                        ...
                        <p>Collect cherished photos, memories, and messages in one place that can be revisited anytime.</p>
                    </div>
                </div>
            </div>
        </main>
